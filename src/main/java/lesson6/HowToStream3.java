...
public class HowToStream3 {
  ...
  public static void main(String[] args) {
    List<String> list = Arrays.asList("Barsik", "Murzik", "Snegok", "Ara");
    ...
    System.out.println(list.stream().filter((s) -> s.contains("i")).collect(Collectors.toList()));
    ...
    System.out
        .println(Arrays.toString(list.stream().map(String::toUpperCase).toArray(String[]::new)));
